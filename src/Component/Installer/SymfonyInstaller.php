...
class SymfonyInstaller extends Installer
{
    /**
     * Steps for Instalation
     * =======================  
     * # composer create-project symfony/skeleton=<version> <dir_to_install>
     * # cd <dir_to_install>
     * ========================
     * Enjoy :)
     */
    ...
    private function createInstllWithComposerScript( string  $installScript, array $predefinedParams )
    {
        ...
        $cmdComposer    = "/usr/local/bin/composer create-project symfony/skeleton={$predefinedParams['version']} {$predefinedParams['version']}";
